...
if (isset($_POST['registrar'])) {
    ...
    $sql = "INSERT INTO productos (codigo, nombre, descripcion, cantidad, precio) 
            VALUES ('$codigo', '$nombre', '$descripcion', '$cantidad', '$precio')";

    if ($conn->query($sql) === TRUE) {
        echo "<script>alert('Producto registrado con éxito'); window.location='ver_productos.php';</script>";
    } else {
